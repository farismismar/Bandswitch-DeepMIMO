...
for userid in np.arange(54481).astype(int):
    ...
    # 2) Now the user in element 3 (or basically time step 3)
    ...
    # This creates a complex version of H, but I believe there must be something faster than this.
    # 256 is num ant x, y, z = 1 x 32 x 8
        
    H_i = pd.DataFrame(channel_i[:, 0])
